#
# Be sure to run `pod lib lint Kitsunebi_Metal.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'Kitsunebi_Metal'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Kitsunebi_Metal.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'Kitsunebi_Metal' => ['Kitsunebi_Metal/Assets/*.png']
  # }
